...
export declare function recordCompaction(sessionId?: string): void;
export declare function resetCompactionRecord(sessionId?: string): void;
/**
 * Calculate context usage statistics.
 */
export declare function calculateContextStats(messages: Message[], model: string, sessionId?: string): ContextStats;
/**
