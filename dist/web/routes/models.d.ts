...
export declare function handleModels(_req: http.IncomingMessage, res: http.ServerResponse): Promise<void>;
/**
 * POST /api/models/verify
 * Tests connectivity for each configured model by calling the API endpoint.
 * Returns { model → { ok, error? } }.
 */
export declare function handleModelsVerify(_req: http.IncomingMessage, res: http.ServerResponse): Promise<void>;
